...
\newcommand{
\itemspacing}{\par\vskip 0.25ex} % Item spacing
...
\begin{minipage}[t]{0.30\textwidth} %% Left column -- outer definition
  ...
  \colorbox{cvblue}{
    ...
    \begin{minipage}[t][\textheight][t]{0.82\textwidth}
      ...
      \null\hfill\includegraphics[width=0.75\textwidth]{images/photo_small.png}\hfill\null
      ...
      \leftsection{Hobbies}
      Photography, Photo Editing, Digital Art, Cooking, Film Watching
